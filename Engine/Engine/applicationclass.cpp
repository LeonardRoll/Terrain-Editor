...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), "../Engine/data/TestHeightMap1.bmp", L"../Engine/data/dirt01.dds");
	if(!result)
	{
...
bool ApplicationClass::HandleInput(float frameTime)
{
	...
	m_Terrain->SwitchTopology(keyDown);
	...
	m_Terrain->IncreaseSmooth(m_Direct3D->GetDevice(),keyDown);
	
	keyDown = m_Input->IsTPressed();
	m_Terrain->PerformRaise(keyDown,posX,posZ,m_Direct3D->GetDevice());
